...
public class RegistrationHandler extends BaseClientRequestHandler {
    ...
    public void handleClientRequest(User sender, ISFSObject params) {
        String playerusername = params.getUtfString("username");
        String playerpassword = params.getUtfString("password");
    ...
    private void sendRegistrationStatusBackToClient(User sender, String RegistrationStatus) {
        ...
        resObj.putUtfString("RegistrationStatus", RegistrationStatus);
